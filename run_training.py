...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics):
    ...
    grid      = EasyDict(size='4k', layout='random')        #8k                   # Options for setup_snapshot_image_grid().
    ...
    sched.minibatch_size_base = 32 #32
    ...
    if config_id in ['config-a', 'config-b', 'config-c', 'config-d']:
        ...
        sched.G_lrate_dict = sched.D_lrate_dict = {64: 0.001, 128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}
        sched.minibatch_size_base = 8#4 #2 # (default)
        sched.minibatch_size_dict = {8: 32, 16: 16, 32: 4, 64: 2} #{8: 256, 16: 128, 32: 64, 64: 32}
        sched.minibatch_gpu_base = 4 #2 # (default)
        sched.minibatch_gpu_dict = {8: 32, 16: 16, 32: 4, 64: 2}  #{8: 32, 16: 16, 32: 8, 64: 4}
